...
const BugReportButton = (): JSX.Element => (
  <button
    ...
    className="fixed bottom-5 right-5 flex items-center gap-2 bg-red-400 text-white px-4 py-2 rounded-full shadow-lg hover:bg-red-700 transition cursor-pointer"
  >
