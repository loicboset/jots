              ...
              <div className='flex justify-between items-center flex-wrap space-y-4'>
                <Link href="/releases" className="inline-flex space-x-6">
                  ...
                  <span className="inline-flex items-center space-x-2 text-sm/6 font-medium text-gray-300">
                    <span className='hidden md:inline'>Just shipped v2025.07.06</span>
                    <ChevronRightIcon aria-hidden="true" className="size-5 text-gray-500" />
                  </span>
                </Link>
                <a href="https://www.producthunt.com/products/jots?embed=true&utm_source=badge-top-post-topic-badge&utm_medium=badge&utm_source=badge-jots" target="_blank" rel="noreferrer">
        ...
        <div className="relative isolate mt-2 px-6 py-32 sm:py-40 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10">
              ...
              <div className="mt-4">
                <a href="https://marketplace.visualstudio.com/items?itemName=jots.dev-journal" rel="noreferrer" target="_blank" className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400 cursor:pointer">
